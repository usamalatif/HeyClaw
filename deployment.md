...
SUPABASE_URL, SUPABASE_ANON_KEY, SUPABASE_SERVICE_ROLE_KEY — same as dev
OPENAI_API_KEY — your OpenAI key (for STT/TTS + standard/power tiers)
ANTHROPIC_API_KEY — your Anthropic key (for OpenClaw / best tier)
